...
const contactInfo = graduates.map(contacts => `${contacts.first_name} ${contacts.email}`);
console.log(contactInfo);


/* Request 3: Find out how many universities have the string "Uni" included in their name. Create a new array called uni that contains them all. Log the result. */
const uni = graduates.filter(word => word.university.includes('Uni'));
...
The zoo wants to display both the scientific name and the animal name in front of the habi
...
const lowerCase = zooAnimals.map(lowercased => lowercased.animal_name.toLowerCase());
